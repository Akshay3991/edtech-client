...
const NewsComponent = () => {
  ...
  const URL = `https://content.guardianapis.com/search?api-key=29c22464-e81b-4fc1-a176-decdaabc7f45&section=technology|education&show-fields=thumbnail,headline,trailText`;
  useEffect(() => {
    axios
      .get(URL)
      .then((response) => {
